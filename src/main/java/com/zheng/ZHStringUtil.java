...
public class ZHStringUtil {
	...
	public static String getZHString(int n) {
		...
		for (int i = 0; i < n; i++) {
			...
			Integer high, low;
			Random r = new Random();
			high = 176 + r.nextInt(41);
			r = new Random();
			low = 161 + r.nextInt(94);
			byte[] b = new byte[2];
	...
	public static String getZHName() {
		...
		String s1=s[RandNumUtil.random(0, s.length-1)];
		String s2=ZHStringUtil.getZHString(RandNumUtil.random(1,2));
